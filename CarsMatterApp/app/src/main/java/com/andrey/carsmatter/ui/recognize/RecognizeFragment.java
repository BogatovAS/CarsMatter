...
public class RecognizeFragment extends Fragment {
    ...
    private RecognizeViewModel slideshowViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        slideshowViewModel =
                ViewModelProviders.of(this).get(RecognizeViewModel.class);
        View root = inflater.inflate(R.layout.fragment_recognize, container, false);
        final TextView textView = root.findViewById(R.id.text_recognize);
